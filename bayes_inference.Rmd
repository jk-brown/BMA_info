...
Here is an exmaple of using `bayes_wts` as the `score_function` argument in `score_hruns` with sample data:

```{r, message=FALSE}
# scoring h_runs

scored_data <- score_hruns_ed(h_result, criterion_co2_obs(), bayes_wts)
